...
if __name__ == "__main__":
    ...
    for number_of_guesses in range(minimum, maximum + 1):
        print(f"Words guessed in {number_of_guesses} tries: {sum([1 for word, guesses in calculated_list.items() if len(guesses) == number_of_guesses])}")
